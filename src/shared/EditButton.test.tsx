...
vi.mock('react-icons/fa', () => ({
  FaPencilAlt: () => <span data-testid="pencil-icon">✏</span>,
}));
...
describe('EditButton', () => {
  ...
  it('applies custom tooltip when provided', () => {
    render(<EditButton onClick={mockOnClick} tooltip="Edit contact details" />);
  ...
  it('enables the button when disabled prop is false', () => {
    render(<EditButton onClick={mockOnClick} disabled={false} />);
