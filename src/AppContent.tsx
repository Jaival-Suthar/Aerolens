...
const AuditLogsPage = lazy(() => import('./pages/AuditLogs/page'));
  ...
  return (
    <Suspense fallback={<LoadingSpinner />}>
      <Routes>
        ...
        <Route
          path="/audit-logs"
          element={<ProtectedRoute><AppLayout><AuditLogsPage /></AppLayout></ProtectedRoute>}
        />
