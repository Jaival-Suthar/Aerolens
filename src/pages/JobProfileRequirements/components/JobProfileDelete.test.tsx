...
// import JobProfileDelete from '../components/jobProfileRequirementsDelete';
// import type { JobProfile, ClientOption } from '../types/jobProfileRequirementsTypes';
...
//       <JobProfileDelete visible={true} onHide={mockOnHide} onDelete={mockOnDelete} jobProfile={null} clients={mockClients} />
//     );
//     expect(container.firstChild).toBeNull();

//     const { container: container2 } = render(
//       <JobProfileDelete visible={false} onHide={mockOnHide} onDelete={mockOnDelete} jobProfile={null} clients={mockClients} />
//     );
...
//     render(
//       <JobProfileDelete visible={true} onHide={mockOnHide} onDelete={mockOnDelete} jobProfile={orphanJobProfile} clients={mockClients} />
//     );
...
//     render(
//       <JobProfileDelete visible={true} onHide={mockOnHide} onDelete={mockOnDelete} jobProfile={jobProfileWithMissingDept} clients={mockClients} />
//     );
...
//     render(
//       <JobProfileDelete visible={true} onHide={mockOnHide} onDelete={mockOnDelete} jobProfile={jobProfileNoLocation} clients={mockClients} />
//     );
...
//     render(
//       <JobProfileDelete visible={true} onHide={mockOnHide} onDelete={mockOnDelete} jobProfile={jobProfileNoClient} clients={mockClients} />
//     );
...
//     render(
//       <JobProfileDelete visible={true} onHide={mockOnHide} onDelete={mockOnDelete} jobProfile={jobProfileNoDept} clients={mockClients} />
//     );
...
//     const pendingJobProfile: JobProfile = { ...mockJobProfile, status: 'Pending' as const };

//     render(
//       <JobProfileDelete visible={true} onHide={mockOnHide} onDelete={mockOnDelete} jobProfile={pendingJobProfile} clients={mockClients} />
//     );
...
//     const closedJobProfile: JobProfile = { ...mockJobProfile, status: 'Closed' as const };

//     render(
//       <JobProfileDelete visible={true} onHide={mockOnHide} onDelete={mockOnDelete} jobProfile={closedJobProfile} clients={mockClients} />
//     );
...
//     const cancelledJobProfile: JobProfile = { ...mockJobProfile, status: 'Cancelled' as const };

//     render(
//       <JobProfileDelete visible={true} onHide={mockOnHide} onDelete={mockOnDelete} jobProfile={cancelledJobProfile} clients={mockClients} />
//     );
