...
vi.mock('primereact/button', () => ({
  Button: ({ label, severity, icon, onClick, disabled, loading, autoFocus, className }: any) => (
    <button
      onClick={onClick}
      disabled={disabled}
      data-testid={severity === 'secondary' ? 'cancel-button' : 'delete-button'}
...
describe('DialogDeleteButton', () => {
  ...
  it('renders both cancel and delete buttons with default labels', () => {
    render(<DialogDeleteButton onCancel={mockOnCancel} onDelete={mockOnDelete} />);
  ...
  it('disables cancel button when cancelDisabled is true', () => {
    render(<DialogDeleteButton onCancel={mockOnCancel} onDelete={mockOnDelete} cancelDisabled={true} />);
  ...
  it('disables delete button when deleteDisabled is true', () => {
    render(<DialogDeleteButton onCancel={mockOnCancel} onDelete={mockOnDelete} deleteDisabled={true} />);
  ...
  it('disables both buttons when loading is true', () => {
    render(<DialogDeleteButton onCancel={mockOnCancel} onDelete={mockOnDelete} loading={true} />);
  ...
  it('applies custom className to both buttons', () => {
    render(<DialogDeleteButton onCancel={mockOnCancel} onDelete={mockOnDelete} className="custom-class" />);
