...
vi.mock("primereact/menu", () => ({
    Menu: ({ model, popup }) => {
        return (_jsx("div", { "data-testid": "settings-menu", children: model?.map((item, idx) => (_jsx("button", { "data-testid": `settings-menu-item-${item.label}`, onClick: item.command, children: item.label }, idx))) }));
    },
}));
// Mock PrimeReact components
vi.mock("primereact/menubar", () => ({
    Menubar: ({ model, start, end }) => (_jsxs("div", { "data-testid": "menubar", children: [_jsx("div", { "data-testid": "menubar-start", children: start }), _jsx("div", { "data-testid": "menubar-items", children: model.map((item, idx) => (_jsxs("div", { "data-testid": `menu-item-${item.label}`, children: [_jsx("button", { onClick: item.command, children: item.label }), item.items && (_jsx("div", { "data-testid": `submenu-${item.label}`, children: item.items.map((subItem, subIdx) => (_jsx("button", { onClick: subItem.command, "data-testid": `submenu-item-${subItem.label}`, children: subItem.label }, subIdx))) }))] }, idx))) }), _jsx("div", { "data-testid": "menubar-end", children: end })] })),
}));
vi.mock("primereact/button", () => ({
    Button: ({ icon, onClick, tooltip, ...props }) => (_jsx("button", { onClick: onClick, "data-testid": `button-${tooltip}`, ...props, children: icon })),
}));
// Mock react-icons
vi.mock("react-icons/fa", () => ({
    FaBriefcase: () => _jsx("span", { "data-testid": "icon-briefcase" }),
    FaUsers: () => _jsx("span", { "data-testid": "icon-users" }),
    FaDatabase: () => _jsx("span", { "data-testid": "icon-database" }),
    FaFile: () => _jsx("span", { "data-testid": "icon-file" }),
    FaChartBar: () => _jsx("span", { "data-testid": "icon-chartbar" }),
    FaIdCard: () => _jsx("span", { "data-testid": "icon-idcard" }),
    FaCog: () => _jsx("span", { "data-testid": "icon-cog" }),
...
describe("AppNavbar", () => {
    ...
    const renderComponent = (pathname = "/home") => {
        ...
        return render(_jsx(MemoryRouter, { children: _jsx(AppNavbar, {}) }));
    };
    describe("Rendering", () => {
