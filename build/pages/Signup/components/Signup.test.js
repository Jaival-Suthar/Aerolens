...
describe('SignupForm', () => {
    ...
    beforeEach(() => {
        ...
        useSignup.fetchDesignations.mockResolvedValue(mockDesignations);
        vi.clearAllMocks();
    });
    afterEach(() => {
        vi.restoreAllMocks();
    ...
    const renderComponent = () => {
        return render(_jsx(BrowserRouter, { children: _jsx(SignupForm, {}) }));
    };
    /**
     ...
     */
    const fillValidForm = async (user, designation = 'Developer') => {
        await waitFor(() => {
    ...
    describe('Form Input Handling', () => {
        ...
        it('updates contact number field on input', async () => {
            ...
            const contactInput = screen.getByPlaceholderText('Enter contact number');
    ...
    describe('Error Handling', () => {
        it('handles designation fetch error', async () => {
            ...
            useSignup.fetchDesignations.mockRejectedValue(new Error('Failed to load designations'));
            renderComponent();
            await waitFor(() => {
