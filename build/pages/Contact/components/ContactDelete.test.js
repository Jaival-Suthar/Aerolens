...
vi.mock('primereact/dialog', () => ({
    Dialog: vi.fn(({ children, visible, header, footer, onHide }) => (_jsxs("div", { "data-testid": "mock-dialog", "data-visible": visible ? 'true' : 'false', "data-header": header, children: [_jsx("button", { "data-testid": "dialog-close-button", onClick: onHide, children: "Close" }), children, _jsx("div", { "data-testid": "dialog-footer-mock", children: footer })] }))),
}));
// Mock the shared component to isolate ContactDelete logic
vi.mock('../../../shared/DialogDeleteButton', () => ({
    default: vi.fn(({ onCancel, onDelete }) => (_jsxs("div", { "data-testid": "mock-delete-button-group", children: [_jsx("button", { "data-testid": "cancel-action-button", onClick: onCancel, children: "Cancel" }), _jsx("button", { "data-testid": "delete-action-button", onClick: onDelete, children: "Delete" })] }))),
}));
// --- Setup Data ---
const mockContact = {
    clientContactId: 101,
...
describe('ContactDelete Component', () => {
    ...
    it('renders the Dialog with the correct header when visible is true', () => {
        render(_jsx(ContactDelete, { ...defaultProps }));
    ...
    it('does not render the Dialog content when visible is false', () => {
        render(_jsx(ContactDelete, { ...defaultProps, visible: false }));
    ...
    it('displays the placeholder text "this contact" when contact is null', () => {
        render(_jsx(ContactDelete, { ...defaultProps, contact: null }));
