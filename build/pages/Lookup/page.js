...
const LookupPage = () => {
    ...
    if (error) {
        return (_jsx("div", { className: "p-4", children: _jsx(Message, { severity: "error", text: error }) }));
    }
    return (_jsx("div", { className: "p-4", children: loading && data.length === 0 ? (_jsx("div", { className: "flex justify-content-center align-items-center", style: { minHeight: '400px' }, children: _jsx(ProgressSpinner, {}) })) : (_jsx(LookupTable, { data: data, meta: meta, loading: loading, onPageChange: handlePageChange, onDataChange: handleDataChange })) }));
};
